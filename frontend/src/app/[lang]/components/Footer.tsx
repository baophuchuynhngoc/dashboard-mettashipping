        ...
        <div className="grid grid-cols-12">
          <div className="pb-6 col-span-full md:pb-0 md:col-span-6  md:block md:justify-start">
            ...
            {socialLinks.map((link: FooterLink) => {
              return (
                ...
                >
                  <Image src={`${process.env.NEXT_PUBLIC_STRAPI_API_URL}${link.socialIcon?.data?.attributes.url}`} width={30} height={30} alt="social-icon" />
                </a>
              );
            })}
          </div>
          ...
          <div className="col-span-12 lg:col-span-6 my-auto">
            ...
            <div className="block lg:flex items-center text-center justify-center lg:justify-end">
                <p className="font-normal mb-4 lg:mb-0 mr-[28px] ">Follow our news</p>
                <input type="email" className="bg-[#F5F5F5] w-2/5 p-3 rounded-[5px]" placeholder="Address e-mail" />
                <button className="p-3 font-medium rounded-[5px] text-white text-ex bg-primary-blue mx-4 lg:mx-[35px]">Submit</button>
            </div>
          </div>
        </div>
